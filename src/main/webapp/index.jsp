...
<html>
    ...
    <body>
        <div class="container">
            ...
            <!-- Acciones -->
            <div class="actions">
                <a href="shop.jsp" class="action-btn">🛒 Ir a la Tienda</a>

                <% if (user.esAdministrador()) { %>
                <a href="productos" class="action-btn">📋 Ver Inventario (Admin)</a>
                <a href="usuarios.jsp" class="action-btn">👥 Gestionar Usuarios</a>
                <% } else { %>
                <a href="mis-pedidos.jsp" class="action-btn">📦 Mis Pedidos</a>
                <% }%>
            </div>
        </div>
    </body>
